...
const FIELDS = [
  { key: "weeklyPlanning",       label: "Weekly Planning",     type: "textarea", required: true, voice: true },
  { key: "fifteenDaysPlanning",  label: "15 Days Planning",    type: "textarea", required: true, voice: true },
  { key: "materialPurchase",     label: "Material Purchase",   type: "textarea", required: true, voice: true }
];
